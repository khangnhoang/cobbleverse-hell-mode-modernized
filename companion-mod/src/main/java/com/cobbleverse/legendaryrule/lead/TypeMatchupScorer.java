...
public final class TypeMatchupScorer {
    ...
    public int mapDefensiveScore(double incomingMultiplier) {
        if (incomingMultiplier == 4.0) return -4;
        if (incomingMultiplier == 2.0) return -2;
        if (incomingMultiplier == 1.0) return 0;
        if (incomingMultiplier == 0.5) return 1;
        if (incomingMultiplier == 0.25) return 2;
        if (incomingMultiplier == 0.0) return 4;
